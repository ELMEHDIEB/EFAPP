...
export default function Sidebar() {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full pt-6 px-4">
      {/* Floating Logo Card */}
      <div className={`mb-8 shrink-0 flex items-center gap-3 bg-surface border border-border p-3 ${tokens.radius.lg} ${tokens.shadows.card}`}>
      ...
      <div 
        ...
        className={`mb-6 shrink-0 flex items-center justify-between p-2.5 bg-surfaceElevated border border-border cursor-pointer hover:border-textdim/50 ${tokens.radius.md} ${tokens.animations.normal}`}
      >
