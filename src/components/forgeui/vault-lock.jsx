...
export const VaultLockGraphic = ({ isOpen }) => {
  const vaultVariant = {
    open: {
  ...
  return (
    <motion.div
      ...
      className="relative h-40 w-full flex justify-center overflow-hidden"
    >
      <motion.div
        variants={vaultVariant}
        className={cn(
          "absolute inset-x-0 mx-auto",
          "top-16 h-32 w-[95%] max-w-[20rem] p-6",
      ...
      <motion.div
        ...
        className={cn(
          "absolute inset-x-0 mx-auto",
          "top-4 flex h-24 w-24 items-center justify-center overflow-hidden rounded-full bg-neutral-950 p-1"
        )}
      >
        <motion.div
          variants={shineVariant}
          className="absolute top-0 left-1/2 h-full w-12 rounded-full bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.5)_30%,white,rgba(255,255,255,0.5)_70%,transparent)] opacity-30"
        />
        <motion.div
        ...
        <div className="absolute inset-x-0 top-0 mx-auto flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-[5px] border-neutral-950" />
      </motion.div>
      <motion.div
        variants={vaultVariant}
        className="absolute inset-x-0 top-4 mx-auto flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-b-[4px] border-neutral-700/70"
      />
    </motion.div>
  );
};
