...
const Animatedform = ({
  ...
  return (
    <div className={cn("relative", "w-full max-w-85")}>
      <div
        className="w-full rounded-[12px] border border-neutral-200/60 p-1.5 dark:border-neutral-900/60">
        <div
          className={cn(
            "relative",
      ...
      <ContainerMask />
      <div
        className="absolute bottom-0 left-0 flex h-12.5 w-full items-center justify-around px-6">
        {icons.map(({ icon, key }) => (
          <div
            key={key}
...
const ContainerMask = () => {
  return (
    <>
      <div
        className="absolute bottom-0 left-0 h-10 w-full bg-[linear-gradient(to_top,var(--color-background)_60%,transparent_100%)]" />
      <div
        className="absolute bottom-0 left-0 h-25 w-3 bg-[linear-gradient(to_top,var(--color-background)_60%,transparent_100%)]" />
      <div
        className="absolute right-0 bottom-0 h-25 w-3 bg-[linear-gradient(to_top,var(--color-background)_60%,transparent_100%)]" />
    </>
  );
};
